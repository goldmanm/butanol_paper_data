...
python $RMG/Arkane.py cantherm_pdep_input.py -o cantherm_output
...
python $RMG/Arkane.py cantherm_high_p_input.py -o cantherm_output_high_p
python $RMG/Arkane.py cantherm_thermo_input.py -o cantherm_output_thermo

echo "****** Merging pdep models and thermo"
mkdir -p ../pdep_merged
cd ../pdep_merged
python $RMG/scripts/mergeModels.py --model1 ../alpha/cantherm_output/chem.inp ../all/cantherm_output_thermo/species_dictionary.txt --model2 ../beta/cantherm_output/chem.inp ../all/cantherm_output_thermo/species_dictionary.txt --model3 ../gamma/cantherm_output/chem.inp ../all/cantherm_output_thermo/species_dictionary.txt --model4 ../all/cantherm_output_thermo/chem.inp ../all/cantherm_output_thermo/species_dictionary.txt

echo "****** Adding thermo to high p model"
mkdir -p ../../high_p_merged
cd ../../high_p_merged
python $RMG/scripts/mergeModels.py --model1 ../all/cantherm_output_thermo/chem.inp ../all/cantherm_output_thermo/species_dictionary.txt --model2 ../all/cantherm_output_high_p/chem.inp ../all/cantherm_output_thermo/species_dictionary.txt
