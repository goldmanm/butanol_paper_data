...
spinMultiplicity = 2
energy = {
    'CBS-QB3': GaussianLog('TS04.log'),
	'CCSD(T)-F12/cc-pVTZ-F12': MolproLog('TS04_f12.out'),
}
frequencies = GaussianLog('TS04freq.log')
...
rotors = [HinderedRotor(scanLog=ScanLog('scan_0.log'), pivots=[7,13], top=[13,14,15,16], symmetry=3),
          ...
          HinderedRotor(scanLog=ScanLog('scan_3.log'), pivots=[7,4], top=[1,2,3,4,5,6], symmetry=1),
