...
energy = {
    'BMK/cbsb7': GaussianLog('TS02bmk.log'),
	'CCSD(T)-F12/cc-pVTZ-F12': MolproLog('TS02bmk_f12.out'),
}

frequencies = GaussianLog('TS02bmkfreq.log')
...
rotors = [HinderedRotor(scanLog=ScanLog('scan_0.log'), pivots=[6,12], top=[12,13,14,15], symmetry=3),
          ...
          HinderedRotor(scanLog=ScanLog('scan_2.log'), pivots=[6,4], top=[1,2,3,4,5,16], symmetry=1),
